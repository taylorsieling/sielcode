            ...
            <div className="code">
                ...
                <div className="console-body">
                    <div className="about-text">
                        ...
                        <p>&gt; Taylor.location <br/>  <span class="about-answer"> &nbsp;&nbsp; =&gt; "Galveston, TX"</span></p>
                        ...
                        <p>&gt; Taylor.skills <br/>  <span class="about-answer"> &nbsp;&nbsp; =&gt; ["Javascript", "React", "Vue", "Ruby", "Rails", "SQL", "HTML", "CSS"]</span></p>
